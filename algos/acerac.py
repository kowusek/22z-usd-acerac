...
from algos.acerac_buffer import AceracPiTrajectoryReplayBuffer
...
from algos.acerac_policy import AceracPolicy


ACERACSelf = TypeVar("ACERACSelf", bound="ACERAC")


class ACERAC(OffPolicyAlgorithm):
    """
    The ACERAC (Actor-Critic with Experience Replay) model class, https://arxiv.org/abs/1611.01224
    ...
    policy_aliases: Dict[str, Type[BasePolicy]] = {
        "MlpPolicy": AceracPolicy,
    }

    policy: AceracPolicy
    replay_buffer: AceracPiTrajectoryReplayBuffer

    def __init__(
        self,
        policy: Union[str, Type[AceracPolicy]],
        ...
        replay_buffer_class: Optional[
            Type[AceracPiTrajectoryReplayBuffer]
        ] = AceracPiTrajectoryReplayBuffer,
    ...
    def _update_learning_rate(self) -> None:
        ...
        if self.policy_class == ACERPolicy or self.policy_class == AceracPolicy:
            update_learning_rate(
    ...
    def collect_rollouts(
        ...
        """
        Collect experiences and store them into a ``AceracPiTrajectoryReplayBuffer``.
